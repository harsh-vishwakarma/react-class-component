...
export class Profile extends Component {
  render() {
    ...
    return (
      <div className="card mb-3 card-bg border border-0" style={{maxWidth: "540px"}}>
        <div className="row g-0">
          ...
          <div className="col-8">
            <div className="card-body pb-1 ">
              <h6 className="card-title fw-bold">{firstName} {lastName}</h6>
              <p className="card-text fw-light">Description...</p>
              {/* <p className="card-text"><small className="text-muted">Last updated 3 mins ago</small></p> */}
              <h6 className="card-title my-2 small-text">
